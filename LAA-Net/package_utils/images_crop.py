...
ROOT = os.getcwd()
SAVE_ROOT = f'{ROOT}/data/deepfake_cluster/datasets_df'
SAVE_DIR = f'{SAVE_ROOT}/FaceForensics++/c23'
# ROOT = 'C:/Users/tevca/Documents/College Work/LAA-Net'
# SAVE_ROOT = 'C:/Users/tevca/Documents/College Work/LAA-Net/data/deepfake_cluster/datasets_df'
# SAVE_DIR = f'{SAVE_ROOT}/FaceForensics++/c23'
...
def facecrop(model, org_path, save_path, period=1, num_frames=10, dataset='original', label=None, mask_path=None, padding=PADDING):
    ...
    for cnt_frame in range(frame_count_org):
        ...
        if face_crop is None or face_crop.size == 0:
            print(f"Invalid face_crop at frame {cnt_frame} in {org_path}")
            continue
...
if __name__=='__main__':
    ...
    if args.dataset=='Original':
        dataset_path='{}/FaceForensics++/c23/original_download/original_sequences/youtube/'.format(ROOT)
    elif args.dataset=='DeepFakeDetection_original':
        dataset_path='/data/FaceForensics++/c23/original_sequences/actors/{}/'.format(args.comp)
    elif args.dataset in ['DeepFakeDetection','FaceShifter','Face2Face','Deepfakes','FaceSwap','NeuralTextures']:
        dataset_path='{}/FaceForensics++/c23/original_download/manipulated_sequences/{}/'.format(ROOT, args.dataset)
    ...
    model.eval()
    # with open("C:/Users/tevca/Documents/College Work/LAA-Net/data/deepfake_cluster/datasets_df/FaceForensics++/original_sequences/youtube/c40/videos/183.mp4") as f:
    #           print("TEST")
    labels = []
    if args.dataset in ['Original','DeepFakeDetection','FaceShifter','Face2Face','Deepfakes','FaceSwap','NeuralTextures']:
        ...
        # print('ROOT DIRECTORY **************'+f'{ROOT}/FaceForensics++/original_download/{args.task}.json')
