...
from lib.core_function_cpu import validate, train
...
if __name__=='__main__':
    ...
    critetion = build_losses(cfg.TRAIN.loss, LOSSES, default_args=dict(cfg=cfg.TRAIN.loss)).to(torch.float64)
    ...
    #     model = nn.DataParallel(model, device_ids=cfg.TRAIN.gpus).to(torch.float64)
    # else:
